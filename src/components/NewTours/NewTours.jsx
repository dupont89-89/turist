...
export default function NewTours(props) {
  ...
  const looking = [
    ...
    {
      id: 'radio-what-7',
      value: 'Ищу попутчицу, попутчика или компанию',
      label: 'Ищу попутчицу, попутчика или компанию',
    },
  ]
  ...
  return (
    <div className={s.blockNewTours}>
        ...
        {({ values, setFieldValue, props }) => (
          <Form>
            <div className={s.sectionDateTours}>
              ...
              <div className={s.gridDataTours}>
                <div>
                  ...
                  <p>
                    Есть уникальная возможность сделать это, выбрать норм дату. Обратите внимание что вы можете сделать
                    пометку для подачи заявки на поиск компании для путешествия
                  </p>
                </div>
                    ...
                    <div role='group' aria-labelledby='radio-group'>
                      <div className={s.radioItem}>
                        <Field
                          ...
                          value='ExactDate'
                        />
                        <label htmlFor='radio1'>Точная дата</label>
                      </div>
                      <div className={s.radioItem}>
                        <Field
                          id='radio2'
                          ...
                          value='ThreeDays'
                        />
                        <label htmlFor='radio2'>Разбег +- 3 дня возможен</label>
                      </div>
                      <div className={s.radioItem}>
                        <Field
                          id='radio3'
                          ...
                          value='Contract'
                        />
                        <label htmlFor='radio3'>Даты обсуждаемы</label>
                      </div>
                    </div>
                  </fieldset>
                </div>
            ...
            <div className={s.sectionFormDescription}>
              <div className={s.textFormDescription}>
                ...
                <Field
                  ...
                  cols='25'
                  rows='5'
                  placeholder='Как прекрасен этом мир...'
                  name='text'
                />
              </div>
            ...
            <div className='sectionFormGoal'>
              <div id={s.checkboxGroupGoal}>
                Цели путешествия<span>*</span>
              </div>
      ...
      <Popup open={showNotification} closeOnDocumentClick onClose={() => setShowNotification(false)}>
